...
if [[ ! -f ${CORTICAL_THICKNESS_IMAGE} ]];
  then
    ...
    logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${CORTICAL_THICKNESS_SEGMENTATION} ${CORTICAL_THICKNESS_SEGMENTATION} 1 1 1
    logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${CORTICAL_THICKNESS_GM} ${CORTICAL_THICKNESS_GM} 1 1 1
    logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${CORTICAL_THICKNESS_WM} ${CORTICAL_THICKNESS_WM} 1 1 1
