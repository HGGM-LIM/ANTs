...
if [[ ${SINGLE_SUBJECT_TEMPLATE_PRIORS_EXIST} -eq 0 ]];
  then
	...
	logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${SINGLE_SUBJECT_TEMPLATE_EXTRACTION_MASK} ${SINGLE_SUBJECT_TEMPLATE_EXTRACTION_MASK} 1 1 1
	logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${SINGLE_SUBJECT_TEMPLATE_SKULL_STRIPPED} ${SINGLE_SUBJECT_TEMPLATE_SKULL_STRIPPED} 1 1 1
