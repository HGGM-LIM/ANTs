...
#                 exe_initial_align="${exe_initial_align} ${EXTRACTION_REGISTRATION_MASK}"
      ...
      if [[ ! -f ${EXTRACTION_SEGMENTATION} ]]; 
	    ...
	    logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${N4_CORRECTED_IMAGES[$i]} ${N4_CORRECTED_IMAGES[$i]} 1 1 1
          done

	logCmd ${ANTSPATH}/CopyImageHeaderInformation ${ANATOMICAL_IMAGES[0]} ${EXTRACTION_MASK} ${EXTRACTION_MASK} 1 1 1
